      ...
      if(isset($this->daterange) && $this->daterange!="")
        {
          ...
          /*$job = DB::select( DB::raw("SELECT * FROM jobs WHERE payload LIKE '%PredictiveDialer%'"));*/
            if(!$job)
            {
                ...
                $this->dispatch(new PredictiveDialer(Auth::id(),$this->list_id,$this->dialerUserName,$this->dialerPassword,$this->campname,$this->skillname,$this->lastFollowUp, $this->onlyNotInt ,$request->new));
