...
Route::group([
    'middleware' => ['auth', 'roles','checkip'],
    'roles' => ['admin', 'marketing','goods_sale','service', 'service_tl']], 
    function() {
...
Route::group([
    ...
    function() {
        ...
        Route::get('nutritionist/performance', 'NutritionistController@performance');
        Route::post('nutritionist/performance', 'NutritionistController@performance');
...
Route::group([
    ...
    Route::get('marketing/YuwowLeads','YuWoWController@YuwowLeads');
    Route::post('marketing/YuwowLeads','YuWoWController@YuwowLeads');
