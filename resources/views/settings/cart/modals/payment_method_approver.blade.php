<div class="container">
    ...
    <div class="col-md-6">
        <div class="panel panel-default"  width="20%">
            <div class="panel-heading">
                <div class="panel-title">Payment Method - {{ $method->name }} </div>
            </div>
    ...
    <div class="col-md-6">
        <div class="panel panel-default"  width="20%">
            ...
            <div class="panel-body">
                <form method="post" action="/settings/cart/payment/method/{{ $method->id }}/approver/add" class="form-inline">
...
<script type="text/javascript">
    ...
    function deleteApprover(id) {
        ...
        if (r==true){
            var url = "/settings/cart/payment/method/approver/"+id+"/delete"; //
            $.ajax(
            {
               type: "POST",
               url: url,
