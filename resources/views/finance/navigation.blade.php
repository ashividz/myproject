                <ul>
                    <li class="active"><a href="/cre"><i class="icon-home"></i> Dashboard</a></li>
                    <li><a href="cre/leads"><i class="icon-graph"></i> Leads</a></li>
                    <li><a href="pipelines"><i class="icon-calendar"></i>Pipelines</a></li>
