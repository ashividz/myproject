...
<body>
    <object width='100%' height='450px' data='data:{{ $bt->mime }};base64,{{ $bt->file_data }}'></object> 
    <p style='margin-top: 10px;font-size: 14px;'>Report file  {{date('jS M, Y', strtotime($bt->report_date))}}</p>
</body>
</html>