<ul id="sidenav">
  	<li{!! (($section == "partials.personal") ? " class='selected'" : "") !!}><a href="/lead/{{ $patient->lead_id }}/viewPersonalDetails">Personal Details</a></li>
  	<li{!! (($section == "partials.contact") ? " class='selected'" : "") !!}><a href="/lead/{{ $patient->lead_id }}/viewContactDetails">Contact Details</a></li>
  	<li{!! (($section == "partials.details") ? " class='selected'" : "") !!}><a href="/lead/{{ $patient->lead_id }}/viewDetails">Lead Details</a></li>
  	<li{!! (($section == "partials.references") ? " class='selected'" : "") !!}><a href="/lead/{{ $patient->lead_id }}/viewReferences">References</a></li>
 	<li{!! (($section == "partials.dispositions") ? " class='selected'" : "") !!}><a href="/lead/{{ $patient->lead_id }}/viewDispositions">Call Dispositions</a></li> 
 	<li{!! (($section == "partials.email") ? " class='selected'" : "") !!}><a href="/lead/{{ $patient->lead_id }}/email">Email</a></li> 
</ul>
...
<ul id="sidenav">
	...
	<li{!! (($section == "partials.diet" || $section == "partials.diets") ? " class='selected'" : "") !!}><a href="/patient/{{ $patient->id or $lead->patient->id  }}/diet">Diet</a></li> 
