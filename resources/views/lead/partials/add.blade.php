...
$(document).ready(function()
{
    ...
    $.getJSON("/api/getSourceList",function(result){
        $.each(result, function(i, field){
            ...
            else if (field.id == 12 || field.id == 13 || field.id == 16 || field.id == 17 || field.id == 26 || field.id == 95 || field.id == 100 || field.id == 102 || field.id == 103 || field.id == 89 || field.id == 110 || field.id == 114 || field.id == 111 || field.id == 117 || field.id == 118 || field.id == 119) {
