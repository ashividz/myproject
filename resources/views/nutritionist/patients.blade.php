<div class="panel panel-default">
	...
	<!-- Nav tabs -->
      	<ul class="nav nav-tabs" role="tablist">
        	...
        	<li role="presentation"><a href="#secondaryappointments" aria-controls="summary" role="tab" data-toggle="tab">Secondary Appointments</a></li>
      	</ul>
...
?>	
	...
	<?php
	  $program_id = [];
	  foreach ($patient->lead->programs as $program) {
	...
	?>
		...
		@elseif(in_array(19, $program_id))
		       <tr tr style="background-color: #2CCEAE">
...
?>
	...
	@endif
			...
			<!-- Secondry Nutritionist appontment  -->
			<div role="tabpanel" class="tab-pane " id="secondaryappointments">
    @if(!$secondaryActivePatient->isEmpty())    	
          	<a name="download" id="app" class="btn btn-primary pull-right" style="margin:10px"><i class="fa fa-download fa-2x" title="Download Appointments as CSV"></i></a>
				<table id="appointment_table" class="table table-bordered">
					<thead>
						<tr>
