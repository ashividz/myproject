<table width='auto' cellspacing='1' cellpadding='1' border="0" style="padding:0 20px;background-color:#fff;">
    <tbody>
        ...
        <tr>
            <td>
               Thank you for choosing Dr. Shikha’s NutriHealth.<p>We have shipped your order via docket no. {{$docket}} with {{$courier}} courier.</p>
               <p>If you have any suggestion/feedback, kindly send us an email at  crc@nutrihealthsystems.com or call us at 1800-103-6663 (toll free).</p>
                Warm Regards,<br>
                Team Dr Shikha's Nutrihealth,<p>
                NUTRIWEL HEALTH (INDIA) PRIVATE LIMITED 
