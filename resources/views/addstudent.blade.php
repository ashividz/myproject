                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="review-content-section">
                                        ...
                                        <p><strong>Well done!!</strong> {{session("message")}} </p>
                                        </div>
                                        @endif
                                        ...
                                        @endif
                                            <form action="{{ route('insertstudent') }}" method="post" class="dropzone dropzone-custom needsclick add-student" id="demo1-upload">
                                            {{csrf_field()}}
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            <input name="student_name" type="text" class="form-control" placeholder="Full Student Name">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input name="mobile_no" type="number" class="form-control" placeholder="Mobile no.">
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="dob" id="finish" type="text" class="form-control" placeholder="Date of Birth">
                                                        </div>
                                                        <div class="form-group">
                                                            <input name="pin_code" id="postcode" type="text" class="form-control" placeholder="Postcode">
                                                        </div>
                                                        <div class="form-group alert-up-pd">
                                                            <div class="dz-message needsclick download-custom">
                                                                ...
                                                                <input name="imageicon" class="hd-pro-img" type="text" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input name="web_url" type="text" class="form-control" placeholder="Website URL">
                                                            </div>
                                                        </div>
                                                    </div>
                                                <div class="row">
