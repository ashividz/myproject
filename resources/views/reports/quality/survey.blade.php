		...
		<div class="panel panel-default"> 
			...
			<div class="panel-body">
				...
				<div class="">
					...
					<button class="btn btn-primary btn-comment" id="{{$question->id}}">View Comments</button>
				</div>
				
				@include('quality/barchart', array('id' => $question->title, 'question' => $question->question, 'count' => $question->total_answers_count, 'survey' => $question->answers))
			</div>
		</div>
	@endforeach
