...
jQuery(function ($) {
    ...
    var modal = {
        message: null,
        init: function () {
            $('#mynutritionist').click(function (e) {
                e.preventDefault();
                var id = $(this).attr('value');

                // load the modal form using ajax
                $.get("/modal/" + id + "/mynutritionist", function(data){
        ...
        validate: function () {
            modal.message = '';
            if (!$('#recipient').val()) {
                modal.message += 'Recipient is required. ';
            }
            else if (!$('#body').val()) {
                modal.message += 'Text message is required. ';
            }
            else if (!$('#subject').val()) {
                modal.message += 'Subject is required. ';
            }
            else {
                return true;
            }
